...
@section('content')
    <div class="mb-8 flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-black text-white mb-2">News erstellen</h1>
            <p class="text-neutral-500">Verfasse einen neuen Beitrag für die Community.</p>
        </div>
        ...
        <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <div class="relative group cursor-pointer">
                    ...
                    <div class="border-2 border-dashed border-white/10 rounded-xl p-8 text-center transition-all group-hover:border-[var(--theme-primary)]/50 group-hover:bg-[var(--theme-primary)]/5">
                        ...
                        <p class="text-neutral-500 text-sm font-bold">Klicken oder Datei hierher ziehen</p>
                        <p class="text-neutral-600 text-xs mt-1">PNG, JPG bis 2MB</p>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <textarea name="content" rows="10" required
                          ...
                          placeholder="Schreibe hier deinen Text... Markdown wird unterstützt."></textarea>
            </div>
